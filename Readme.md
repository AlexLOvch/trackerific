# This fork and my commit there is the decision of test tasks(description is bellow). My proposal to use existent gem(trackerific), and I added needed functionality there.
